...
import { ALGORITHM_DATASHEETS } from "@/lib/tutorial/datasheets";

export function TechDatasheet({ algorithm }: { algorithm: AlgorithmId }) {
  const d = ALGORITHM_DATASHEETS[algorithm];
